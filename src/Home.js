        ...
        <div>
            ...
            <div className="flex-container">
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1AZRPVoifoLjTv_aQbfLUHowC7FsjLvaI/view">
                        <img className="box-img" src={book_1} alt="Accounting_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1WdYv8m83e5_RBBVdonYfjtJSX7QGL6sd/view">
                        <img className="box-img" src={book_2} alt="Budgeting_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1B8CpWsMurie_uGcZQ54JxRVPL7GGIHvg/view">
                        <img className="box-img" src={book_3} alt="DayTrading_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1Ddk5jcQYN85cJlRDSLOhxbjjw2R7eLf3/view">
                        <img className="box-img" src={book_4} alt="Debt_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1Xq31OCvkRVH8zjFPvgdrirYOGqOiIVy1/view">
                        <img className="box-img" src={book_5} alt="Economics_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1JFubhW1eH2zDGbDCIBUBvkONzc-Twjun/view">
                        <img className="box-img" src={book_6} alt="Investing_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/10VqYt2wS5qSHtkn3KaWBu3MBK0DpdTW5/view">
                        <img className="box-img" src={book_7} alt="Management_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1eLDWzlMobrHhtC_8OWIH5vjPeb5NptuF/view">
                        <img className="box-img" src={book_8} alt="Negotiating_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/16FIJ54WIj3WXpY3Op9f82d41_4QPwXQC/view">
                        <img className="box-img" src={book_9} alt="PersonalFinance_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1aKUUG8e61-95fVE_Yr7JztpOUxJ0fDm_/view">
                        <img className="box-img" src={book_10} alt="RealEstateInvesting_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1ERdfR9sJv3_UHjayuxOs1lO5e1e8lwNN/view">
                        <img className="box-img" src={book_11} alt="Sales_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1--wfxuNamUSclY0DYYW-1M9YliWn1nKn/view">
                        <img className="box-img" src={book_12} alt="Statistics_101" title=""/></a>
                </div>
                <div className="flex-item">
                    <a href="https://drive.google.com/file/d/1_LUBeEtBlzMN1rlMCPjyJQldXYQVAkyw/view">
                        <img className="box-img" src={book_13} alt="StockMarket_101" title=""/></a>
                </div>
...
{/* -------------- Adding a button -------------- */}
{/* <div className="flex-item">
    <button className="addBookButton" onClick={addBook}>
        Add Book
    </button>
</div> */} 
